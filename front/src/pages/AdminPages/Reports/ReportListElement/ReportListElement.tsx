...
const ReportListElement: FC<ReportListElementProps> = ({ label, name, labelPosition, disabled }) => {
    return (
        <div className={styles.container}>
            <Form.Item name={name} noStyle valuePropName="checked">
                <AntCheckbox disabled={disabled} labelPosition={labelPosition}>{label}</AntCheckbox>
            </Form.Item>
        </div>
    );
};
