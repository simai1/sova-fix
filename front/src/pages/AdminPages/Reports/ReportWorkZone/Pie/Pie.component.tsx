...
const PieComponent: FC<PieComponentProps> = ({ pieReportData, isEmptyChart }) => {
        ...
        <div className={styles['chart-wrapper']}>
          ...
          <div className={styles.legend}>
            {pieReportData.map((item, idx) => (
              <div
                key={idx}
                className={`${styles.legendItem} ${activeIndex === idx ? styles.activeLegend : ''}`}
                onMouseEnter={() => setActiveIndex(idx)}
                onMouseLeave={() => setActiveIndex(null)}
              >
                <span className={styles.legendDot} style={{ backgroundColor: PIE_COLORS[idx] }} />
