...
const DirectoryCategory: FC = () => {
  ...
  const [selectedRowState, setSelectedRowState] = useState<GetDirectoryCategoryResponse | null>(
    null,
  );
      ...
      <div className={styles.header}>
        <div className={styles.text__header}>
          ...
          <div className={styles.clear}>
            <button onClick={() => dispatch(resetFilters({ tableName: 'table14' }))}>
              <img src={ClearImg} />
            </button>
          </div>
        </div>
        {userRole && (
          <div className={styles.button__header}>
            ...
            <button disabled={isEditButtonDisabled} onClick={handleOpenEditModal}>
              Редактировать
            </button>

            <button disabled={isDeleteButtonDisabled} onClick={handleOpenConfirm}>
              Удалить
            </button>
          </div>
        )}
